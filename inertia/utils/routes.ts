const routesObject = {
  ...
  "web.auth.vendor.signup": "/auth/vendor-signup/:type",
  "web.auth.vendor.signup.new.post": "/auth/signup/new",
  "web.auth.vendor.signup.existing.post": "/auth/signup/existing-user",
  ...
  "web.contactus": "/contact-us",
  "web.faqs": "/faqs",
  "web.helpcenter.index": "/helpcenter",
  "web.helpcenter.show": "/helpcenter/:slug",
  "web.blogs.index": "/blogs",
  "web.blogs.show": "/blogs/:slug",
  ...
  "web.booking.address.post": "/bookings/checkout/address",
  "web.booking.payment": "/bookings/checkout/payment",
  "web.booking.payment.post": "/bookings/checkout/payment",
  ...
  "web.custom_booking.create": "/custom-bookings/create",
  ...
  "web.service_requirement.negotiate": "/requirements/:id/negotiate",
  ...
  "web.under-maintenance": "/under-maintenance",
  "web.deined": "/denied",
  "web.comming-soon": "/comming-soon",
  "vendor.dashboard": "/vendor/dashboard",
  "vendor.service.index": "/vendor/services",
  "vendor.service.create": "/vendor/services/create",
  "vendor.service.show": "/vendor/services/:slug",
  "vendor.service.create.post": "/vendor/services",
  "vendor.service.edit": "/vendor/services/:slug/edit",
  "vendor.service.edit.post": "/vendor/services/:id",
  "vendor.service.delete": "/vendor/services/:id",
  "vendor.service.image.delete": "/vendor/services/:id/delete-image/:imageId",
  "vendor.booking.index": "/vendor/bookings",
  "vendor.booking.show": "/vendor/bookings/:id",
  "vendor.booking.update-status": "/vendor/bookings/:id/update-status",
  "vendor.booking.request-completion": "/vendor/bookings/:id/request-completion",
  "vendor.booking.accept-completion": "/vendor/bookings/:id/accept-completion",
  "vendor.custom-booking.index": "/vendor/custom-bookings",
  "vendor.custom-booking.show": "/vendor/custom-bookings/:id",
  "vendor.custom-booking.update-status": "/vendor/custom-bookings/:id/update-status",
  "vendor.custom-booking.request-completion": "/vendor/custom-bookings/:id/request-completion",
  "vendor.custom-booking.accept-completion": "/vendor/custom-bookings/:id/accept-completion",
  "vendor.requirements.index": "/vendor/requirements",
  "vendor.requirements.show": "/vendor/requirements/:id",
  "vendor.my-bids.index": "/vendor/my-bids",
  "vendor.bids.create": "/vendor/create-bid",
  "vendor.bids.accept_negotiate": "/vendor/bids/:id",
  "vendor.coupon.index": "/vendor/coupons",
  "vendor.coupon.create": "/vendor/coupons/create",
  "vendor.coupon.show": "/vendor/coupons/:slug",
  "vendor.coupon.create.post": "/vendor/coupons",
  "vendor.coupon.edit": "/vendor/coupons/:id/edit",
  "vendor.coupon.edit.post": "/vendor/coupons/:id",
  "vendor.coupon.delete": "/vendor/coupons/:id",
  "vendor.timeslot-plans.index": "/vendor/timeslot-plans",
  "vendor.timeslot-plans.create": "/vendor/timeslot-plans",
  "vendor.timeslot-plans.edit": "/vendor/timeslot-plans/:id/edit",
  "vendor.timeslot-plans.update": "/vendor/timeslot-plans/:id",
  "vendor.timeslot-plans.destroy": "/vendor/timeslot-plans/:id",

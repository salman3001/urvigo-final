...
import horizontalLight from '~/assets/images/customizer-icons/horizontal-light.svg'
import { AppContentLayoutNav, ContentWidth } from '@layouts/enums'
import { cookieRef, namespaceConfig } from '@layouts/stores/config'
import { themeConfig } from '~/themeConfig'

import borderSkin from '~/assets/images/customizer-icons/border-light.svg'
import collapsed from '~/assets/images/customizer-icons/collapsed-light.svg'
import compact from '~/assets/images/customizer-icons/compact-light.svg'
import defaultSkin from '~/assets/images/customizer-icons/default-light.svg'
import ltrSvg from '~/assets/images/customizer-icons/ltr-light.svg'
import rtlSvg from '~/assets/images/customizer-icons/rtl-light.svg'
import wideSvg from '~/assets/images/customizer-icons/wide-light.svg'
...
const setPrimaryColor = useDebounceFn((color: { main: string; darken: string }) => {
  ...
  cookieRef<string | null>(`${vuetifyTheme.name.value}ThemePrimaryDarkenColor`, null).value =
    color.darken
...
const currentLayout = ref<'vertical' | 'collapsed' | 'horizontal'>(
  configStore.isVerticalNavCollapsed ? 'collapsed' : configStore.appContentLayoutNav
)
...
const resetCustomizer = async () => {
  if (isCookieHasAnyValue.value) {
    ...
    useStorage<string | null>(namespaceConfig('initial-loader-color'), null).value =
      staticPrimaryColor
          ...
          <div class="d-flex flex-column gap-2">
            ...
            >
              ...
              <div
                ...
                "
                :class="
                  vuetifyTheme.current.value.colors.primary === customPrimaryColor ? 'active' : ''
                "
                :style="
                  vuetifyTheme.current.value.colors.primary === customPrimaryColor
                  ...
                  <VList>
                    <VListItem>
                      <VColorPicker
                        ...
                        :modes="['hex']"
                        @update:model-value="
                          setPrimaryColor({ main: customPrimaryColor, darken: customPrimaryColor })
                        "
                      />
                    </VListItem>
                  </VList>

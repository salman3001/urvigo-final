...
import navImg from '~/assets/images/front-pages/misc/nav-item-col-img.png'
    ...
    <div>
      <div class="d-flex flex-column gap-y-4 pa-4">
        <Link
          ...
          :class="[page.url === item.link ? 'active-link' : '']"
        >
          {{ item.label }}
        </Link>
        ...
        <!-- <Link to="/" target="_blank" class="font-weight-medium nav-link">
          Admin
        </Link> -->
      </div>
    </div>
                        ...
                        <ul>
                          ...
                          >
                            <Link
                              ...
                              :href="listItem.to"
                              :class="
                                isCurrentRoute(listItem.to) ? 'active-link' : 'text-high-emphasis'
                              "
                            >
                              <div class="d-flex align-center">
                                <VIcon

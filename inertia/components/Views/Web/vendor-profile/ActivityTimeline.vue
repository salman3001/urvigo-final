    ...
    <VCardText>
      <VTimeline side="end" align="start" line-inset="8" truncate-line="start" density="compact">
        ...
        <VTimelineItem dot-color="primary" size="x-small">
          ...
          <!-- 👉 Content -->
          <div class="app-timeline-text mt-1">Invoices have been paid to the company</div>

          <div class="d-inline-flex align-center timeline-chip mt-2">
            <img :src="pdf" height="20" class="me-2" alt="img" />
            <span class="app-timeline-text font-weight-medium"> invoice.pdf </span>
          </div>
        </VTimelineItem>
        <!-- !SECTION -->
        ...
        <VTimelineItem size="x-small" dot-color="success">
          ...
          <div class="app-timeline-text mt-1">Project meeting with john @10:15am</div>
        ...
        <VTimelineItem size="x-small" dot-color="info">
          <!-- 👉 Header -->
          <div class="d-flex justify-space-between align-center flex-wrap mb-2">
            <span class="app-timeline-title"> Create a new project for client </span>
          ...
          <div class="v-avatar-group demo-avatar-group">
            ...
            <VAvatar :size="40">
              <VImg :src="avatar2" />
              <VTooltip activator="parent" location="top"> Jennie Obrien </VTooltip>
            </VAvatar>

            <VAvatar :size="40">
              <VImg :src="avatar3" />
              <VTooltip activator="parent" location="top"> Peter Harper </VTooltip>
            </VAvatar>

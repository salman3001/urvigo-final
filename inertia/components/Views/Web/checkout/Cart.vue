      ...
      <div class="border rounded" v-if="summary">
        ...
        >
          ...
          <div>
            <VImg
              width="140"
              :src="getImageUrl(summary?.service_variant?.image?.breakpoints?.thumbnail?.url)"
            />
          </div>
          ...
          <div class="d-flex w-100 flex-column flex-md-row flex-grow-1">
            ...
            >
              <div class="d-flex text-base align-self-md-end">
                <div class="text-primary">&#x20B9;{{ summary?.total_after_discount }}</div>
                <div
        ...
        <VCardText>
          ...
          <div class="text-high-emphasis" v-if="summary">
            ...
            <div class="d-flex justify-space-between mb-2">
              ...
              <span class="text-medium-emphasis">&#x20B9;{{ summary?.grand_total }}</span>
            </div>

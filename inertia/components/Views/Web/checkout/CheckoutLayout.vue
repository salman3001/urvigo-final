...
<template>
    ...
    <VCard>
        <VCardText>
            <!-- 👉 Stepper -->
            <AppStepper :current-step="step" class="checkout-stepper" :items="checkoutSteps"
                :direction="$vuetify.display.mdAndUp ? 'horizontal' : 'vertical'" :is-active-step-valid="true"
                align="center" />
        </VCardText>
        ...
        <VCardText>
            <!-- 👉 stepper content -->
            <VWindow :model-value="0" class="disable-tab-transition" :touch="false">
                <VWindowItem>
                    <slot />
                </VWindowItem>
            </VWindow>

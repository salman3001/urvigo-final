...
import logo1dark from '~/assets/images/front-pages/branding/logo-1-dark.png'
import logo1light from '~/assets/images/front-pages/branding/logo-1-light.png'
import logo1 from '~/assets/images/front-pages/branding/logo-1.png'
import logo2dark from '~/assets/images/front-pages/branding/logo-2-dark.png'
import logo2light from '~/assets/images/front-pages/branding/logo-2-light.png'
import logo2 from '~/assets/images/front-pages/branding/logo-2.png'
import logo3dark from '~/assets/images/front-pages/branding/logo-3-dark.png'
import logo3light from '~/assets/images/front-pages/branding/logo-3-light.png'
import logo3 from '~/assets/images/front-pages/branding/logo-3.png'
import logo4dark from '~/assets/images/front-pages/branding/logo-4-dark.png'
import logo4light from '~/assets/images/front-pages/branding/logo-4-light.png'
import logo4 from '~/assets/images/front-pages/branding/logo-4.png'
import logo5dark from '~/assets/images/front-pages/branding/logo-5-dark.png'
import logo5light from '~/assets/images/front-pages/branding/logo-5-light.png'
                  ...
                  <swiper-slide v-for="(data, index) in reviewData" :key="index">
                    <VCard class="d-flex h-100 align-stretch">
                      <VCardText class="pa-6 d-flex flex-column justify-space-between align-start">
                        <img :src="data.img" style="block-size: 1.375rem" class="mb-3" />
                        <p class="text-body-1">
                          {{ data.desc }}
                        </p>
                        ...
                        <div class="d-flex align-center gap-x-3">
                          <VAvatar :image="data.avatar" size="32" />
                          <div>
                            <h6 class="text-h6">
                              {{ data.name }}
                            </h6>
...
.section-title::after {
  position: absolute;
  background: url('../../../../assets/images/front-pages/icons/section-title-icon.png') no-repeat
    left bottom/contain;

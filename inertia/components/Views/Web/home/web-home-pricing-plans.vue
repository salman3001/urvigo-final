...
import { ref } from 'vue'
import paperPlane from '~/assets/images/front-pages/icons/paper-airplane.png'
import plane from '~/assets/images/front-pages/icons/plane.png'
import pricingPlanArrow from '~/assets/images/front-pages/icons/pricing-plans-arrow.png'
import shuttleRocket from '~/assets/images/front-pages/icons/shuttle-rocket.png'
    ...
    <VContainer>
      <div class="pricing-plans">
        ...
        <div class="headers d-flex justify-center flex-column align-center flex-wrap">
          <VChip label color="primary" class="mb-4" size="small"> Pricing Plans </VChip>
          <h4 class="d-flex align-center text-h4 mb-1 flex-wrap justify-center">
            <div class="position-relative me-2">
              <div class="section-title">Tailored design plans</div>
            </div>
            designed for you
          </h4>
          <div class="text-center text-body-1">
            ...
            <p class="mb-0">Choose the best plan to fit your needs.</p>
          </div>
        </div>
        <!-- 👉 Annual and monthly price toggler -->
        <div class="d-flex align-center justify-center mx-auto mt-6 mb-16">
          <VLabel for="pricing-plan-toggle" class="me-3"> Pay Monthly </VLabel>
          <div class="position-relative">
            <VSwitch id="pricing-plan-toggle" v-model="annualMonthlyPlanPriceToggler">
              <template #label>
                <div class="text-body-1">Pay Annually</div>
              </template>
            </VSwitch>
            <div class="position-absolute pricing-plan-arrow d-md-flex d-none">
              ...
              <div class="text-no-wrap text-body-1 font-weight-medium">Save 25%</div>
            </div>
          </div>
        </div>
        <VRow>
